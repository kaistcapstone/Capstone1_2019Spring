...
int low_h_r=0, low_s_r=160, low_v_r=100;
...
int low_h_b=100, low_s_b=200, low_v_b=170; //135
int high_h_b=120, high_s_b=255, high_v_b=205; //205
...
int main(int argc, char **argv)
{
  ...
  //   createTrackbar("Min Threshold:","Canny Edge for Blue Ball", &lowThreshold_b, 100, on_canny_edge_trackbar_blue);
   ...
   ros::init(argc, argv, "ball_detect_near_node"); //init ros nodd
